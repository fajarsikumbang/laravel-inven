...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="/masterbarang">Inventory</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        <a class="nav-link {{ request()->is('masterbarang') ? 'active' : '' }}" href="/masterbarang">
                        ...
                        <a class="nav-link {{ request()->is('barangkeluar') ? 'active' : '' }}" href="/barangkeluar">
                            <div class="sb-nav-link-icon {{ request()->is('barangkeluar') ? 'active' : '' }}">
